...
themes = [
    ...
    Theme(name="Nightfox",               type="dark",  neovim_repo="https://github.com/EdenEast/nightfox.nvim.git",   neovim_dir_name="nightfox.nvim",    neovim_name="nightfox",         neovim_global_vars=None,                                                                      ghostty_source=ThemeGhosttyName("Nightfox")),
    Theme(name="Nightfox Carbonfox",     type="dark",  neovim_repo="https://github.com/EdenEast/nightfox.nvim.git",   neovim_dir_name="nightfox.nvim",    neovim_name="carbonfox",        neovim_global_vars=None,                                                                      ghostty_source=ThemeGhosttyName("Carbonfox")),
    Theme(name="Nightfox Dawnfox",       type="light", neovim_repo="https://github.com/EdenEast/nightfox.nvim.git",   neovim_dir_name="nightfox.nvim",    neovim_name="dawnfox",          neovim_global_vars=None,                                                                      ghostty_source=ThemeGhosttyName("Dawnfox")),
    Theme(name="Nightfox Dayfox",        type="light", neovim_repo="https://github.com/EdenEast/nightfox.nvim.git",   neovim_dir_name="nightfox.nvim",    neovim_name="dayfox",           neovim_global_vars=None,                                                                      ghostty_source=ThemeGhosttyName("Dayfox")),
    Theme(name="Nightfox Duskfox",       type="dark",  neovim_repo="https://github.com/EdenEast/nightfox.nvim.git",   neovim_dir_name="nightfox.nvim",    neovim_name="duskfox",          neovim_global_vars=None,                                                                      ghostty_source=ThemeGhosttyName("Duskfox")),
    Theme(name="Nightfox Nordfox",       type="dark",  neovim_repo="https://github.com/EdenEast/nightfox.nvim.git",   neovim_dir_name="nightfox.nvim",    neovim_name="nordfox",          neovim_global_vars=None,                                                                      ghostty_source=ThemeGhosttyName("Nordfox")),
    Theme(name="Nightfox Terafox",       type="dark",  neovim_repo="https://github.com/EdenEast/nightfox.nvim.git",   neovim_dir_name="nightfox.nvim",    neovim_name="terafox",          neovim_global_vars=None,                                                                      ghostty_source=ThemeGhosttyName("Terafox")),
