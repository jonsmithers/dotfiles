# https://gist.githubusercontent.com/britishtea/39ad478fa5180e1432a2/raw/c56527202e8152b2db40473608ef114a6736aaae/fish_right_prompt.fish
...
function fish_custom_mode_prompt --description 'Displays the current mode'
  ...
  case insert
    ...
    # echo 'INSERT'
  case visual
    set_color --bold --background FFA500 red
    echo -n 'VISUAL'
  end
  set_color normal
end
